...
def parse_args():
    ...
    # args.reward_writer_path = os.path.join(args.tb_path, "train_reward")
    # args.rl_loss_writer_path = os.path.join(args.tb_path, "rl-loss")
    # args.cl_loss_writer_path = os.path.join(args.tb_path, "cl-loss")
    #
    # args.log_path = os.path.join(save_path_base, "logs_pt.txt")
